<?php
	...
	if (@$_POST['updateasset']) {
		...
		if ($success)
			output_success_text('Package successfully updated in transaction '.$issuetxid);
	}
			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data" action="./?chain=<?php echo html($_GET['chain'])?>&page=<?php echo html($_GET['page'])?>">
				<div class="form-group">
					<div class="row row-width">
						<label for="issuetxid" class="col-lg-2 control-label">Package:</label>
						<div class="col-lg-10">
							<select class="form-control col-sm-8" name="issuetxid" id="issuetxid">
							<?php
								foreach ($listassets as $asset) {
									$issuer=$asset['issues'][0]['issuers'][0];
				...
				<div class="form-group">
					<div class="row row-width">
						...
						<div class="col-lg-10">
							<input class="form-control col-sm-8" name="qty" id="qty" value="0">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="row row-width">
						<label for="upload" class="col-lg-2 control-label">Update file:<br/><span style="font-size:75%; font-weight:normal;">Max <?php echo floor($max_upload_size/1024)?> KB</span></label>
						<div class="col-lg-10">
				...
				?>
						<div class="form-group">
							<div class="row row-width">
								<div class="col-lg-3"><label for="key<?php echo $index?>" class="control-label"><?php echo $index ? '' : 'Update fields:'?></label></div>
								<div class="col-lg-9">
									<div class="col-sm-3">
				...
				<div class="form-group">
					<div class="row row-width">
						...
						<div class="col-sm-offset-2 col-sm-5">
							<input class="btn btn-primary" style="float:right" type="submit" name="updateasset" value="Update Package">
						</div>
					</div>
				</div>
			</form>
