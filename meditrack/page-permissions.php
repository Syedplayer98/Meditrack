		...
		<div style="margin-bottom: 50px" class="table-agile-info">
			...
			<form class="form-horizontal" method="post" action="./?chain=<?php echo html($_GET['chain'])?>&page=<?php echo html($_GET['page'])?>">
				<div class="form-group">
					<div class="row">
						<label for="from" class="col-lg-4 control-label" style="padding: 0px 0px 0px 30px">Admin address:</label>
				...
				<div class="form-group">
					<div class="row">
						<label for="to" class="col-lg-4 control-label" style="padding: 0px 0px 0px 30px">For address:</label>
						<div class="col-lg-6" style="padding-left: 0px">
				...
				<div class="form-group">
					<div class="col-sm-offset-3 col-sm-9">
						<input class="btn btn-primary" type="submit" name="grantrevoke" value="Change Permissions">
					</div>
				</div>
			</form>
		</div>
